      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Por que escolher a Oliveira & Melli?</h2>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              >
                <g fill="none" fillRule="evenodd">
                  <rect
                    className="fill-current text-custom-100"
                    width="64"
                    height="64"
                    rx="32"
                  />
          ...
          <div className="flex justify-center my-12">
            ...
            >
              <button
                type="button"
                className="rounded-md bg-custom-100 px-8 py-2.5 text-lg font-semibold text-gray-900 shadow-sm hover:bg-gray-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-500"
              >
                Agendar consulta
              </button>
            </Link>
